...
CREATE TABLE "new_Driver" (
    ...
    "veiculoId" INTEGER NOT NULL DEFAULT 0,
    CONSTRAINT "Driver_veiculoId_fkey" FOREIGN KEY ("veiculoId") REFERENCES "Vehicle" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_Driver" ("ativado", "cadastro", "id", "nome", "rfid", "veiculoId") SELECT "ativado", "cadastro", "id", "nome", "rfid", coalesce("veiculoId", 0) AS "veiculoId" FROM "Driver";
DROP TABLE "Driver";
